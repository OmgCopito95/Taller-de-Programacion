...
public class Ejercicio4_Parte2 {
    public static void main(String[] args) {
        ...
        for (i=0;i<dias;i++){  //Imprimir Matriz     //-----------> CUANDO IMPRIMAS LA MATRIZ NO PODES USAR UN FOR PORQUE NO NECESARIAMENTE ESTA TODA LLENA.
                                                        //POR LO QUE HAY POSICIONES EN NULL Y SE VA A ROMPER TODO
